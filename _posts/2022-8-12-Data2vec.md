...
이러한 self-supervised learning은 Computer vision, NLP, Speech에 사용된 경우를 확인해 보자. 

CV의 경우는 크게 **Rotation**과 **Context prediction**이 있다 [7]. 
...
9. [blog : 초간단 논문리뷰, data2vec](https://everyday-deeplearning.tistory.com/m/entry/data2vec-A-General-Framework-for-Self-supervised-Learning-in-Speech-Vision-and-Language)
