...
encoding of the un- masked training sample의 경우 an exponentially moving average (EMA)을 통해 parameterize되는데, 이때 두개의 parameters인 student model weight, 𝝷와 teacher model weight, 𝝙 을 어떻게 학습시키는지가 중요하다. 
...
<p align="center">
<img src="/images/data2vec_target01.png" width="400">
</p>



<p align="center">
<img src="/images/data2vec_target02.png" width="400">
</p>
