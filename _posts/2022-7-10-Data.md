...
사과가 떨어지는 것을 관측하고 정립한 **뉴턴의 만유인력의 법칙**, 피사의 사탑에서 서로 다른 무게의 물체를 떨어트린 실험/관측한 **갈릴레오의 낙하실험** , 넘치는 목욕물을 관측한 후 유레카를 외쳐서 유명해진 **Archimedes' principle (부력)** 등이 있다. 이러한 것들도 관측된 데이터를 기반으로 하고 있다. 
