...
과정을 Pseudo-code로 본다면 아래와 같다[14].

<p align="center">
<img src="/images/Pseudo_code_BO.png" width="600">
</p>

코드에서 5번인 statistical model은 surrogate model, 즉 GPR이라고 볼 수 있다. 

이러한 과정을 schematic으로 확인하면 좀 더 직관적으로 이해할 수 있다 [14].
...
조금 더 이해를 쉽게 하기 위해 작은 petit schematic을 그려보았다 (아래 schematic은 제가 작성한 것 입니다.).
...
black circle (검은색 점)은 이미 알고 있는 데이터 (observed data p't)이고, 
