...
Acquisition function에서 사용하는 exploitation과 exploration에 대한 정의는 아래와 같고, 이 둘의 balance를 잘 유지하면서 next query p't를 찾아주는 것이 acquisition function의 역할이라 할 수 있다 [15, 16]. 
