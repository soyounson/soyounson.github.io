...
i 번째 데이터 포인트에서 mean function과 covariance function (or kernel) 은 ![image](https://user-images.githubusercontent.com/40614421/176209785-549b9c88-45a8-426e-a6ba-40b482f2bca5.png)
이다. 
...
이제, n+1번째 새로운 데이터를 k라고 놓고, 이때 f(x)에 대한 conditional distribution (posterior probability)를 구하면, 

![image](https://user-images.githubusercontent.com/40614421/176212205-723d5362-b8e8-4ff1-ae30-b981ad3f97b8.png)
...
여기서는 Gaussian Process Regression (GPR)을 이용해서 mean과 covariance를 구하고, 이 값들을 aquisition function에 업데이트 시켜준다. 
